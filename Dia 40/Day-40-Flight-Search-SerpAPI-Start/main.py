...
costumer_data = data_manager.get_costumers_emails()
costumer_email_list = [row["whatIsYourEmail?"] for row in costumer_data]
#pprint(costumer_email_list)
...
for destination in sheet_data:
    ...
    if cheapest_flight.price == "N/A":
        ...
        print(f"Cheapest indirect flight is: GBP {cheapest_flight.price}")
    ...
    if cheapest_flight.price != "N/A" and cheapest_flight.price < destination["lowestPrice"]:
        ...
        notification_manager.send_email(email_list=costumer_email_list, email_body=message)
